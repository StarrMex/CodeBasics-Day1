...
var lucky11Main = function (guess) {
  ...
  if (guess == diceRoll1 || guess == diceRoll2 || diceRoll1 + diceRoll2 == 11) {
...
var fourDWinningRangeMain = function (fourDGuess) {
  ...
  var isGuessInWinningRange = calcIfGuessInWinningRange(
    fourDGuess,
    winningNum,
    winningRange
  );
  var genericOutput = `Your guess: ${fourDGuess}. Winning range: ${
